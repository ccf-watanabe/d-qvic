...
<table cellpadding="0" cellspacing="0" class="baseTable">
...
<?php if ($mailContent['MailContent']['auth_captcha']): ?>
	<?php if (!$freezed): ?>
		<div class="auth-captcha">
			...
			<span class="auth-captcha-message">画像の文字を入力してください</span>
...
<div class="submit">
	<?php if ($freezed): ?>
	<?php echo $this->Mailform->submit('　書き直す　', array('div' => false, 'class' => 'btn btn-reset form-submit', 'id' => 'BtnMessageBack')) ?>
	<?php echo $this->Mailform->submit('　送信する　', array('div' => false, 'class' => 'btn btn-submit form-submit', 'id' => 'BtnMessageSubmit')) ?>
	<?php else: ?>
		<input name="resetdata" value="　取り消す　" type="reset" class="btn-gray button" />
	<?php echo $this->Mailform->submit('　入力内容を確認する　', array('div' => false, 'class' => 'btn btn-submit form-submit', 'id' => 'BtnMessageConfirm')) ?>
	<?php endif; ?>
</div>
